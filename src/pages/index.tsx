  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Home Account - Your ultimate solution for entering earnings and expenditures, ensuring effective control and monitoring of your finances."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661956602868-6ae368943878?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxmaW5hbmNlfGVufDB8fHx8MTY5MDIxMjk5NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Home Account - Your ultimate solution for entering earnings and expenditures, ensuring effective control and monitoring of your finances.`}
            </Text>
            <Box
