...
import { getAnalysisNotesById } from 'apiSdk/analysis-notes';
import { AnalysisNotesInterface } from 'interfaces/analysis-notes';

function AnalysisNotesViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Note" text={data?.note} />

                <FormListItem label="Date" text={format(parseISO(data?.date as unknown as string), 'dd-MM-yyyy')} />
