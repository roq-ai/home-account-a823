...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'analysis_notes.count', 'earnings.count', 'expenditures.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('analysis_notes', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'analysis_notes',
          header: 'Analysis Notes',
          accessorKey: 'analysis_notes',
          cell: ({ row: { original: record } }: any) => record?._count?.analysis_notes,
        }
      : null,
    hasAccess('earnings', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'earnings',
          header: 'Earnings',
          accessorKey: 'earnings',
          cell: ({ row: { original: record } }: any) => record?._count?.earnings,
        }
      : null,
    hasAccess('expenditures', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'expenditures',
          header: 'Expenditures',
          accessorKey: 'expenditures',
          cell: ({ row: { original: record } }: any) => record?._count?.expenditures,
        }
      : null,
